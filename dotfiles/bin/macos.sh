...
LanguageRegion() {
  ...
  defaults write .GlobalPreferences AppleLanguages -array en de-DE

  # ========== Region ==========
  # - Germany
  defaults write .GlobalPreferences AppleMetricUnits -int 1
  defaults write .GlobalPreferences AppleLocale -string "de-DE"
...
Keyboard() {
  ...
  # @int:second
  sudo /usr/libexec/PlistBuddy -c "Set :KeyboardBacklight:KeyboardBacklightIdleDimTime 5" ${NPLIST}
...
ExtraSettings() {
  ...
  dockitem=(
    "Kontakte"                "com.apple.AddressBook"                     "file:///System/Applications/Contacts.app/"
    "Kalender"                "com.apple.iCal"                            "file:///System/Applications/Calendar.app/"
    ...
    "Adobe Lightroom Classic" "com.adobe.LightroomClassicCC7"             "file:///Applications/Adobe%20Lightroom%20Classic/Adobe%20Lightroom%20Classic.app/"
  )
